...
class _LoginPageState extends State<LoginPage> {
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        child: Image.asset('asets/Ozonlogo.png',fit: BoxFit.contain,height:(small)? 150:160,),
                      ),
                    ),
                    //Finish
  ...
  void submit() async {
    ...
    if(validateAndSave()){
      ...
      LoginUser user = LoginUser.fromJson(LoginValue);//value come from loginAPI return value
      if(user.msgs!=null){
        Navigator.pop(context,true);
        Navigator.push(
        context,
        new MaterialPageRoute(
          builder: (BuildContext context) => DashBoard(email:email,)));
      }else{
        showDialog<void>(
                      context: context,
