...
class pavilionHeight extends StatefulWidget {
  @override
  _pavilionHeightState createState() => _pavilionHeightState();
}

class _pavilionHeightState extends State<pavilionHeight> {
  bool size=false;
  @override
